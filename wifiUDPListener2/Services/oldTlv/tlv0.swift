...
//        var delay_frame = [Int]()
//        let width = readUInt32LE(img, 0x12)
...
//                }
//                for bit in 0..<(gray+1) {
//                    self.getColorMatrix(img, offset, &outImg, Int(width), Int(height), rowStripe, 2, 7 - bit);
//                    if ( typeColor > 1) {
//                        self.getColorMatrix(img, offset, &outImg, Int(width), Int(height), rowStripe, 1, 7 - bit);
//                        if ( typeColor > 2) {
//                            self.getColorMatrix(img, offset, &outImg, Int(width), Int(height), rowStripe, 0, 7 - bit);
//                        }
//                    }
//                }
//
...
//                guard let uiimage_data = frame.toData(options: [:], type: .bmp) else {return}
//                if (img.count==0){
//                    // first bmp
//                    img += [UInt8](uiimage_data)
//                }else{
//                    // other bmp only raw data, therefore dont need first 54 bytes
//                    img += [UInt8](uiimage_data)
//                }
//            }
//        }
